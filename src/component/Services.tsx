const Services = () => {
  return (
    <div className="py-60 px-8 md:px-32 min-h-screen" id="services">
      <div className="text-center mb-10">
        <h2 className="text-3xl font-semibold text-[#CFD6F6]">Services</h2>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">

        {/* Front End Card */}
        <div className="p-6 border-2 border-[#0ef] rounded-lg shadow-md hover:shadow-2xl transform transition-all duration-300 hover:scale-105">
          <h3 className="text-xl font-semibold text-center text-[#CFD6F6] mb-4">Front End</h3>
          <p className="text-[#627189] text-center mb-6">
        ...
        {/* Other Card */}
        <div className="p-6 border-2 border-[#0ef] rounded-lg shadow-md hover:shadow-xl transform transition-all duration-300 hover:scale-105">
          <h3 className="text-xl font-semibold text-center text-[#CFD6F6] mb-4">Back End</h3>
          <p className="text-[#627189] text-center mb-6">
          ...
          <div className="flex flex-wrap justify-center gap-2">
            ...
            <button className="px-4 py-1 rounded-lg bg-transparent border-[rgba(0, 24, 69, 0.6)] border-2 text-[#606060]">MySQL</button>
            <button className="px-4 py-1 rounded-lg bg-transparent border-[rgba(0, 24, 69, 0.6)] border-2 text-[#606060]">Git</button>
x            <button className="px-4 py-1 rounded-lg bg-transparent border-[rgba(0, 24, 69, 0.6)] border-2 text-[#606060]">Spring Boot</button>
         ...
         {/* UI-UX Design Card */}
         <div className="p-6  border-2 border-[#0ef] rounded-lg shadow-md hover:shadow-2xl transform transition-all duration-300 hover:scale-105">
          <h3 className="text-xl font-semibold text-center text-[#CFD6F6] mb-4">Mobile Development</h3>
          <p className="text-[#627189] text-center mb-6">
